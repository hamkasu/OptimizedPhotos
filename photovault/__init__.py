...
def create_app():
    ...
    # Configure template and static folder paths relative to project root
    ...
    if is_production:
        ...
        app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL', 'sqlite:///instance/photovault.db')
